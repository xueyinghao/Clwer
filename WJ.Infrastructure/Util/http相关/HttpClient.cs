...
namespace WJ.Infrastructure.Util
{
    public class HttpClient
    {
        ...
        private string defalutdomain = "eeeff.com";     //?应该是 defaultdomain
        ...
        public HttpClient(string url, HttpClientContext context, bool keepContext)
        {
            ...
            if (this.context == null)
            {
                ...
                this.context.Cookies = new CookieCollection();
            }
        }
        #endregion
        ...
        public string GetString()
        {
            try
            {
                ...
                byte[] data = IOHelper.ConvertStreamToByteBuffer(stream);
    ...
    public class HttpUploadingFile
    {
        ...
        public HttpUploadingFile(byte[] data, string fileName, string fieldName, string contentType)
        {
            ...
            this.fileName = fileName;
            this.fieldName = fieldName;
            this.ShortName = System.IO.Path.GetFileName(fileName);
